...
app.use((req, res, next) => {
  ...
  res.header("Access-Control-Allow-Headers", ["Origin, X-Requested-With, Content-Type,Accept,Authorization,application/x-www-form-urlencoded,multipart/form-data,text/plain"]);
